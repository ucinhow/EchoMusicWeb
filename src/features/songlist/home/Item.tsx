...
export const Skeleton = () => (
  <div
    role="status"
    className="animate-pulse flex flex-col space-y-1.5 justify-start w-full"
  >
    <div className="flex items-center justify-center w-[14.5rem] h-[14.5rem] flex-grow-0 bg-gray-300 rounded-lg dark:bg-gray-700">
      <svg
